...
namespace Xylab.Polygon.TagHelpers
{
    ...
    public class VerdictTagHelper : XysTagHelper
    {
        ...
        {
            var v = (int)Value;
            if (IsTooLate) return ("sol sol_queued", "too-late");
            else if (Skipped) return ("sol sol_queued", "skipped");
            else return ("sol sol_" + st[v].Item2, st[v].Item1);
        }
